package com.ogaclejapan.web.view;
...
import com.ogaclejapan.web.Application;
import com.ogaclejapan.web.Application.JSON;
...
public class ViewTemplate {
	...
	/** 
	 * @param path パス文字列
	 * @return {@link #page()}に{@code path}を加えたURLを返す
	 */
	 ...
	 * @return {@link #asset()}に{@code source}を加えたURLを返す
	 */
	...
	/** 
	 * {@link #asset(String)}に{@code '/js/$source'}を加えたURLを返す
	...
	/**
	 * {@link #asset(String)}に{@code '/css/$source'}を加えたURLを返す
	 ...
	 * @return メッセージリソースから{@code 'label.$code'}に該当する文字列を返す
	 */
	...
	/** 
	 * @param code メッセージコード
	 * @return メッセージリソースから{@code '$code'}に該当する文字列を返す
	 */
	 ...
	 * @return メッセージリソースから{@code '$code'}に該当する文字列に{@code args}をバインドして返す
	 */
